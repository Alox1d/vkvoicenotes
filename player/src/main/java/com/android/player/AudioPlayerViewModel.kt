...
class AudioPlayerViewModel : ViewModel() {
    ...
    companion object {
        ...
        private val TAG = AudioPlayerViewModel::class.java.name
        private var mInstance: AudioPlayerViewModel? = null

        @Synchronized
        fun getPlayerViewModelInstance(): AudioPlayerViewModel {
            if (mInstance == null) {
                mInstance = AudioPlayerViewModel()
            }
            return mInstance as AudioPlayerViewModel
        }
    }
